...
import useMutation from "../../hooks/useMutation";
import useQuery from "../../hooks/useQuery";
import SaveDataComponent from "./SaveDataComponent"; // Import the SaveDataComponent
      ...
      <Col xs={24} md={12}>
        ...
        {qrData && (
          <div>
            ...
            {/* Render the SaveDataComponent and pass dataWithTimestamp as a prop */}
            <SaveDataComponent dataWithTimestamp={userData} />
          </div>
        )}
      </Col>
